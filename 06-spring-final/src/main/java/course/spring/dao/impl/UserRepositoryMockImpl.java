...
public class UserRepositoryMockImpl implements UserRepository {
    private List<User> users = List.of(
            ...
            new User(2L, "User", "Two", LocalDate.now(), "user2", "user2",  Role.AUTHOR, "user2@gmail.com", true),
            new User(3L, "User", "Three", LocalDate.now(), "user3", "user3", Role.AUTHOR, "user3@gmail.com", true)
    );
